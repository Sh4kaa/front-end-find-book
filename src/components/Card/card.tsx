...
export const Card = ({ id }: { id: string }) => {
  ...
  return (
    <div className='grid grid-cols-3 gap-3 shadow-lg rounded-lg border- border-gray-100 max-w-lg w-full p-4'>
      <img className='w-full rounded-lg' src="https://s3.amazonaws.com/AKIAJC5RLADLUMVRPFDQ.book-thumb-images/ableson.jpg" alt="opa" />
      <div className='col-span-2'>
        ...
        <Button onClick={handleSelect} variant='light' className='w-1/2'>Ver mais</Button>
      </div>
    </div>
  )
}
